    ...
    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display"
        ...
        <tbody>
            ...
            <tr class="odd gradeX">
                ...
                <td class="center" style="border:0px">
                    <a href="#" data-name="{{ $empleado->nombre }}" data-url="{{ url('empleado/' . $empleado['id']) }}" data-toggle="modal" onclick="deleteElement({{$empleado->id}}, '{{$empleado->nombre}}','empleado')" data-target="#modalDelete">Borrar</a>
                </td>
                <td class="center" style="border:0px">
                    <a href="#">Imagen</a>
                </td>
        ...
        <form action="{{ url('img') }}" method="post" enctype="multipart/form-data">
            ...
            <input type="submit">Subir imagen</input>
        </form>
</div>

                @foreach($imagenes as $imagen)
                <img src="{{ url('storage/img/'.$imagen->nombrearchivo) }}" alt="" title="" /> 
                <form>
                    <p>{{$imagen->nombreoriginal}}</p>
...
<script src="{{ url('assets/js/borrarEmpleado.js') }}"></script>
<script src="{{ url('assets/js/hola.js') }}" type="text/javascript"></script>
