...
<div class="span3">
    <div class="sidebar">
        <ul class="widget widget-menu unstyled">
            ...
            <li><a href="{{url('departamento')}}"><i class="menu-icon icon-bullhorn"></i>Añadir Departamentos </a>
            </li>
 ...
 <form class="form-horizontal row-fluid" action="{{ url('departamento') }}" method="post" >
     @csrf
     @method('post')
	...
	<div class="control-group"  style="margin-top:220px">
	    <br>
		<label class="control-label" for="basicinput" >Nombre departamento:</label>
		<div class="controls">
			<input type="text" id="basicinput" name="nombre" placeholder="Introduce el nombre del departamento" class="span8" style="margin-left:30px;">
		</div>
		<br>
		<label class="control-label" for="basicinput">Localizacion:</label>
		<div class="controls">
			<input type="text" id="basicinput" name="localizacion" placeholder="Ejemplo: 5" class="span8" style="margin-left:30px">
		</div>
		<br>
	    <label class="control-label" for="basicinput">IdempleadoJefe</label>
