                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Borrar Puesto</h5>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display"
        ...
        <tbody>
            ...
            <tr class="odd gradeX">
                ...
                <td class="center" style="border:0px">
                    <a href="#" data-name="{{ $puesto->nombre }}" data-url="{{ url('puesto/' . $puesto['id']) }}" data-toggle="modal" onclick="deleteElement({{$puesto->id}}, '{{$puesto->nombre}}','puesto')" data-target="#modalDelete">Borrar</a>
                </td>
            </tr>
...
<script src="{{ url('assets/js/borrarPuesto.js') }}"></script>
